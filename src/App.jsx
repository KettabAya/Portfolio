...
export const projectsData = [
  ...
  { 
    ...
    desc: [
      "An intelligent conversational AI assistant designed for NHSM school that leverages modern retrieval-augmented generation (RAG) architecture to provide accurate, context-aware responses to student and staff inquiries."
    ],
    fullDesc: [
      ...
      "• MongoDB with Mongoose - NoSQL database for knowledge base storage",
      "• Groq LLM API - Large language model inference (Llama 3.1)",
      "• Cohere AI - Alternative AI capabilities integration",
      "\u00A0",
      "TECH STACK (AI & ML):",
      "• Vector Embeddings - In-memory cosine similarity for semantic search",
      "• RAG (Retrieval-Augmented Generation) - Hybrid approach combining retrieval with generation"
    ],
